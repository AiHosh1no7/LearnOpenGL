...
int main() {
    ...
    Shader asteroidShader("../shader/Instancing/asteroids.vert", "../shader/Instancing/asteroids.frag");
    Shader planetShader("../shader/Instancing/planet.vert", "../shader/Instancing/planet.frag");

    unsigned int amount = 4000;
    glm::mat4 *modelMatrices;
    modelMatrices = new glm::mat4[amount];
    srand(static_cast<unsigned int>(glfwGetTime()));
    float radius = 50.0f, offset = 2.5f;
    ...
    while (!glfwWindowShouldClose(window)) {
		...
		for (auto & meshe : rock.meshes) {
			...
			glDrawElementsInstanced(GL_TRIANGLES, static_cast<unsigned int>(meshe.indices.size()),
